    ...
    return (
      <div className="navFlex">
        {props.sections.map((section) => (
          <NavLink url={section.url} key={section.url} active={section.url === pathname} component={<Button color="inherit">{section.name}</Button>} />
        ))}
  ...
  // Mobile menu:
    <div className="mobileFlex">
      ...
      <StyledMenu
        ...
        onClose={handleClose}
      >
        {props.sections.map((section) => <NavLink url={section.url} key={section.url} active={section.url === pathname} component={<MenuItem color="inherit" onClick={handleClose} selected={section.url === pathname} key={section.name}>{section.name}</MenuItem>} />)}
